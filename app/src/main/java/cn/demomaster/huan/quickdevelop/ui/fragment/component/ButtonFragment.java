 ...
 * 2018/8/25
 */
@ActivityPager(name = "按钮", preViewClass = QDButton.class, resType = ResType.Resource,iconRes = R.drawable.ic_button)
public class ButtonFragment extends QuickFragment {
