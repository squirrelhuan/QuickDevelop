...
@ActivityPager(name = "小程序",preViewClass = TextView.class, resType = ResType.Resource,iconRes = R.mipmap.ic_applet)
public class MyAppletsFragmentActivity extends QDActivity {
