...
//setListener方法
    ...
    class QueryListener implements OnClickListener{
        ...
        public void onClick(View v) {
            ...
            //参数6：having条件
            //参数7：排序方式
            Cursor cursor = App.instance.db.query("inner_department_category", new String[]{"id","name","code"}, "id=?", new String[]{"1"}, null, null, null);
    ...
    class DeleteListener implements OnClickListener{
        ...
        public void onClick(View v) {
            ...
            //调用delete方法，删除数据
            App.instance.db.delete("inner_department_category", whereClauses, whereArgs);
        }
    }
}
