...
import java.util.List;
     ...
     */
    public class LabNestedScrollView extends FrameLayout implements NestedScrollingParent3,
         ...
         *
         * @see #setOnScrollChangeListener(LabNestedScrollView.OnScrollChangeListener)
         */
        public interface OnScrollChangeListener {
             ...
             */
            void onScrollChange(LabNestedScrollView v, int scrollX, int scrollY,
        ...
        private LabNestedScrollView.SavedState mSavedState;

        private static final LabNestedScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new LabNestedScrollView.AccessibilityDelegate();
        ...
        private LabNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;

        public LabNestedScrollView(@NonNull Context context) {
            this(context, null);
        }

        public LabNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        protected float getBottomFadingEdgeStrength() {
            ...
            final LabNestedScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
            final int length = getVerticalFadingEdgeLength();
         ...
         */
        public void setOnScrollChangeListener(@Nullable LabNestedScrollView.OnScrollChangeListener l) {
        ...
        int getScrollRange() {
            ...
            if (getChildCount() > 0) {
                View child = getChildAt(0);
                LabNestedScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
                int childSize = child.getHeight() + lp.topMargin + lp.bottomMargin;
                int parentSpace = getHeight() - getPaddingTop() - getPaddingBottom();
        ...
        public boolean pageScroll(int direction) {
            ...
            if (down) {
                ...
                if (count > 0) {
                    ...
                    LabNestedScrollView.LayoutParams lp = (LayoutParams) view.getLayoutParams();
        ...
        protected void onRestoreInstanceState(Parcelable state) {
            if (!(state instanceof LabNestedScrollView.SavedState)) {
                super.onRestoreInstanceState(state);
                return;
            }

            LabNestedScrollView.SavedState ss = (LabNestedScrollView.SavedState) state;
        ...
        protected Parcelable onSaveInstanceState() {
            ...
            LabNestedScrollView.SavedState ss = new LabNestedScrollView.SavedState(superState);
        ...
        static class SavedState extends BaseSavedState {
            ...
            public static final Parcelable.Creator<LabNestedScrollView.SavedState> CREATOR =
                    new Parcelable.Creator<LabNestedScrollView.SavedState>() {
                        @Override
                        public LabNestedScrollView.SavedState createFromParcel(Parcel in) {
                            return new LabNestedScrollView.SavedState(in);
                        }

                        @Override
                        public LabNestedScrollView.SavedState[] newArray(int size) {
                            return new LabNestedScrollView.SavedState[size];
                        }
                    };
        }
        ...
        static class AccessibilityDelegate extends AccessibilityDelegateCompat {
            ...
            public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
                ...
                final LabNestedScrollView nsvHost = (LabNestedScrollView) host;
