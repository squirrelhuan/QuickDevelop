...
public class QDViewDrag extends LinearLayout {
    ...
    public QDViewDrag(Context context) {
        this(context, null);
    }

    public QDViewDrag(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QDViewDrag(Context context, AttributeSet attrs, int defStyle) {
