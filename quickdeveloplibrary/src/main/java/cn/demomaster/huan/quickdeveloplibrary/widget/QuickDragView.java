 ...
 * 可拖动子布局
 */
public class QuickDragView extends FrameLayout {

    private static final String TAG = QuickDragView.class.getSimpleName();

    private ViewDragHelper mViewDragHelper;

    private ViewDragHelper.Callback mDragCallback;

    public QuickDragView(Context context) {
        this(context, null);
    }

    public QuickDragView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QuickDragView(Context context, AttributeSet attrs, int defStyle) {
