    ...
    private void drawView(Canvas canvas) {
        ...
        switch (stateType) {
            case COMPLETE://完成
                ...
                float h1 = r / 5;
                PointF pointF1 = new PointF(width / 4 + w1 / 2, height / 3);
                //Path path1 = new Path();
            ...
            case ERROR://异常
                ...
                float B_w1 = r / 7;
                float B_h1 = r / 5;
                PointF B_pointF1 = new PointF(width / 4 + B_w1 / 2, height / 3);
                ...
                PointF B_pointF2 = new PointF(width * 3 / 4 - B_w1 / 2, height / 3);
                ...
                PointF B_pointF3 = new PointF(width / 2, height * 3 / 4);
                Path B_path = new Path();
                B_path.moveTo(B_pointF3.x - r / 2, B_pointF3.y);
                B_path.quadTo(B_pointF3.x, B_pointF3.y - r * 2 / 5 * progress, B_pointF3.x + r / 2, B_pointF3.y);
