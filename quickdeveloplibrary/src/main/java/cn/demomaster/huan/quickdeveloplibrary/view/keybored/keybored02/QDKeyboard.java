...
public class QDKeyboard {
    ...
    public QDKeyboard(Activity mContext) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_keyboard_containor_03, null);
        this.mContext = mContext;
        this.keyboardContainerResId = R.layout.layout_keyboard_containor_03;
    ...
    private void initKeyboard() {
        ...
        keyboardNumber_Only = new Keyboard(mContext, R.xml.keyboard_num_only_03);            //实例化数字键盘
        ...
        keyboardView.setOnClickListener(v -> {
       ...
       /* iv_keyboardDone.setImageDrawable(hideDrawable);
        ...
        setDelDrawable(mContext.getResources().getDrawable(R.drawable.icon_del2));
