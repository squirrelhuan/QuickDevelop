 ...
 * description：加载动画
 */
public class LoadingCube3View extends View {

    public LoadingCube3View(Context context) {
        super(context);
    }

    public LoadingCube3View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LoadingCube3View(Context context, AttributeSet attrs, int defStyleAttr) {
