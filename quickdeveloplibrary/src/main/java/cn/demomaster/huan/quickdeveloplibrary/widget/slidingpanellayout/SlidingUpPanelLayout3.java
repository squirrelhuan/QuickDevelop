 ...
 * 定制化 抽屉布局高度支持动态变化
 */
public class SlidingUpPanelLayout3 extends ViewGroup {

    private static final String TAG = SlidingUpPanelLayout3.class.getSimpleName();
    ...
    private static final float DEFAULT_TOP_ANCHOR_POINT = 0f;
    private static final float DEFAULT_BOTTOM_ANCHOR_POINT = 1.0f;
     ...
     * used for dragging.
     * 如果提供，则只能通过此视图拖动面板。否则，整个面板可用于拖动。
     */
    ...
    private float mTopAnchorPoint = 0.f;
    private float mBottomAnchorPoint = 1.f;
    ...
    public SlidingUpPanelLayout3(Context context) {
        this(context, null);
    }

    public SlidingUpPanelLayout3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingUpPanelLayout3(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                ...
                mTopAnchorPoint = ta.getFloat(R.styleable.SlidingUpPanelLayout_umanoTopAnchorPoint, DEFAULT_TOP_ANCHOR_POINT);
                mAnchorPoint = ta.getFloat(R.styleable.SlidingUpPanelLayout_umanoAnchorPoint, DEFAULT_ANCHOR_POINT);
                mBottomAnchorPoint = ta.getFloat(R.styleable.SlidingUpPanelLayout_umanoBottomAnchorPoint, DEFAULT_BOTTOM_ANCHOR_POINT);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int height = layoutHeight- lp.topMargin;
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        boolean result;
        final int save = canvas.save();//TODO Canvas.CLIP_SAVE_FLAG
