...
Java_cn_demomaster_huan_quickdeveloplibrary_jni_Watcher_createWatcher(JNIEnv *env, jobject instance,
                                                                      jstring userId_,
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_demomaster_huan_quickdeveloplibrary_jni_Watcher_connectMonitor(JNIEnv *env,
                                                                       jobject instance) {
    int socked;
    while (1) {
